...
class Paint extends JFrame implements MouseListener {
	...
	public Paint(String title) {
		...
		JToolBar colorB = new JToolBar(SwingConstants.VERTICAL) {
			{
		...
		this.circularMenu.add(tool);
		this.circularMenu.add(colorB);
		pack();
		setVisible(true);
		this.circularMenu.setVisible(false);
	}
	...
	public void mousePressed(MouseEvent arg0) {
		this.circularMenu.setVisible(true);
